...
final class ArticleEntity: Model, @unchecked Sendable {
    ...
    init(id: Int? = nil, slug: String, thumbnailId: Int? = nil, title: String, excerpt: String, content: String, category: String, status: String, comment: String, publishedOn: Date? = nil, authorId: Int, createdAt: Date? = nil, modifiedAt: Date? = nil) {
